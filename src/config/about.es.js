export const ABOUT_ES = {
  ...
  page: {
    ...
    heroLine1: 'Microbiología',
    heroAccent: 'al servicio',
    heroLine2: 'de la agricultura',
    heroSubtitle: 'Empresa de biotecnología agrícola especializada en soluciones biológicas de alto desempeño. Innovación, ciencia y sostenibilidad al servicio del agricultor.',
    stats: [
