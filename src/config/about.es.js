export const ABOUT_ES = {
  ...
  page: {
    ...
    emailLabel: 'Email',
    socialLabel: 'Redes',
    railLabel: 'Capítulos de la historia',
    chapters: [
      { id: 'origins', label: 'Origen' },
      { id: 'philosophy', label: 'Filosofía' },
      { id: 'process', label: 'Proceso' },
      { id: 'team', label: 'Equipo' },
      { id: 'contact', label: 'Contacto' },
    ],
    flowLabel: 'Descubrir · Confiar · Contactar',
    trustLabel: 'Señales de confianza',
    trustPills: ['Cepas seleccionadas', 'Validación en campo', 'Soporte técnico real'],
    philosophySteps: ['01 — El suelo', '02 — El reto', '03 — La respuesta'],
    imageCaptions: {
      brotes: 'Vida desde la raíz',
      soil: 'Ecosistema vivo',
      crops: 'Productividad sostenible',
      research: 'Investigación aplicada',
      microscope: 'Microbiología de precisión',
    },
  },
}
